...
fileRoot = 'dataSynthInfTest-pop1e8'
...
def plotPosteriorHistos(postFileName,estimator,obsData, fltrDeath, Tf_inference,param_priors,
                   ...
                   infResult,parameters_true,trueInit,empColor='lightblue') :
    ...
    mapArgs = {'ms':13,'color':'blue','marker':'*','label':'MAP','linestyle':'none'}
    trueArgs = {'ms':10,'color':'red','marker':'o','label':'true','linestyle':'none'}
    priArgs = {'lw':3.5,'color':'darkgreen','label':'prior'}
...
plotPosteriorHistos(postFigFileName,estimator,obsData, fltrDeath, Tf_inference,
                   ...
                   infResult,parameters_true,trueInit,empColor='dodgerblue')
